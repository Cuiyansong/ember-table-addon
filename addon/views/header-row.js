...
export default Ember.View.extend(
  StyleBindingsMixin, RegisterTableComponentMixin, {
    ...
    // TODO: if the length of 'columns' larger than 1, it is a group.
    isAGroup: Ember.computed(function () {
    ...
    didInsertElement: function () {
      console.log("inner column insert");
      this._super();
      if (this.get('tableComponent.enableColumnReorder') && this.get('isAGroup')) {
        this.$('> div').sortable(this.get('sortableOption'));
      }
    },

    willDestroyElement: function () {
      console.log("inner column destroy");
      if (this.get('tableComponent.enableColumnReorder')  && this.get('isAGroup')) {
